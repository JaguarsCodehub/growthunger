export const notifications = [
    ...
    },
    {
        ...
        title: "Netflix added us to their 'must-watch' list!",
        message: "From Vision to Growth—The Tech Builders. Starring: You.",
        timestamp: 'now',
    },
    {
        id: '4',
        avatar: '/images/gmail.png',
        title: 'Inbox zero? Try GrowthHunger!',
        message: "‘Add GrowthHunger to your priority inbox.’ Gmail’s top tip.",
        timestamp: 'now',
    },
    {
        id: '5',
