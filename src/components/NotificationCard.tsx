...
const NotificationCard: React.FC<NotificationCardProps> = ({ notification }) => {
    ...
    return (
        <div className={`bg-white border border-gray-400 w-[350px] md:w-[550px] bg-opacity-70 backdrop-blur-xl shadow-lg rounded-lg p-4 flex items-center justify-between fade-in-out`}>
